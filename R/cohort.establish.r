...
#' 
#' @return A vector with the new tree species in after drought-induced mortality
#' 
#' @export
#' 
#' @examples
...
#' data(clim)
#' data(sdm)
#' kill.cells = drought(landscape, clim, 10, 1)
#' landscape$tsdist[landscape$cell.id %in% killed.cells] = 0
#' landscape$typdist[landscape$cell.id %in% killed.cells] = "drght"
#' cohort.establish(landscape, coord, orography, clim, sdm)
#' 

cohort.establish = function(land, coord, orography, sdm, params){
