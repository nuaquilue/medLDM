forest.mgmt = function(land, harvest, clim, t, dmnd.sawlog=0, dmnd.wood=0, policy="BAU"){
  ...
  suit.mgmt = suit.mgmt %>% left_join(ba.volbark, by="spp") %>% mutate(vol=c_ba*biom/10+c2_ba*biom*biom/100) 
